...
public class TokenService {
    ...
    public void store(String token, UserSession authentication) {
    ...
    public UserSession retrieve(String token) {
        return (UserSession) restApiAuthTokenCache.get(token).getObjectValue();
    }
}
